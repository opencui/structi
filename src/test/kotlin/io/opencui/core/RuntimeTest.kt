...
class RuntimeTest {
    ...
    fun testBasics() {
        val coreExpected = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.Fever","slot":"degree"}]}""",
    ...
    fun testBasics2() {
        val coreExpected = listOf(
            ...
            """<{"type":"SlotAskAction","payload":"What is the cause for it?"}""",
            """<{"activeFrames":[{"frame":"io.opencui.test.Headache","slot":"cause"}]}""",
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.Headache","slot":"part"}]}""",
            ...
            """<{"type":"SlotAskAction","payload":"What symptom do you have?"}""",
            """<{"activeFrames":[{"frame":"io.opencui.core.HasMore","slot":"status"},{"frame":"io.opencui.test.PreDiagnosis","slot":"symptoms"}]}""",
            ...
            """<{"activeFrames":[{"frame":"io.opencui.core.HasMore","slot":"status"},{"frame":"io.opencui.test.PreDiagnosis","slot":"indexes"}]}""",
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.PreDiagnosis","slot":"indexes"}]}""",
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.MobileWithAdvances","slot":"name"}]}""",
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.Mobile","slot":"cellphone"}]}""",
            """>{"query": "35", "frames": [{"type": "Mobile", "slots": [{"value" : "\"fever\"", "type" : "String", "attribute" : "cellphone"}]}]}""",
            """<{"type":"SeqAction","payload":[{"type":"SlotNotifyFailure","payload":"your cellphone number is not correct, let's try it again."},{"type":"CleanupAction","payload":"CLEANUP SLOT : target=io.opencui.test.Mobile&slot=cellphone"},{"type":"RefocusAction","payload":""}]}""",
            """<{"type":"SlotAskAction","payload":"What is your cell number?"}""",
            """<{"activeFrames":[{"frame":"io.opencui.test.Mobile","slot":"cellphone"}]}""",
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.Mobile","slot":"amount"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
    ...
    fun testCompositeSkill() {
        val compositeSkillTestCase = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.BookFlight","slot":"origin"}]}""",
            ...
            """<{"type":"SlotValueInform","payload":"flight CA1001 is booked for you"}""",
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.BookHotel","slot":"checkout_date"}]}""",
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.Hotel","slot":"hotel"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.BookHotel","slot":"placeHolder"}]}""",
            """>{"query": "9", "frames": [{"type": "HotelAddress", "slots": []}]}""",
            """<{"type":"SlotAskAction","payload":"Which city?"}""",
            """<{"activeFrames":[{"frame":"io.opencui.test.Hotel","slot":"city"}]}""",
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.HotelAddress","slot":"unimportant"}]}""",
            ...
            """<{"activeFrames":[{"frame":"io.opencui.core.Confirmation","slot":"status"},{"frame":"io.opencui.test.BookHotel"}]}""",
    ...
    fun testIIntent() {
        val iintentTestcase = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.CompositeWithIIntent","slot":"skill"}]}""",
    ...
    fun testIntentAction() {
        val intentActionTestCase = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.BookHotel","slot":"checkin_date"}]}""",
    ...
    fun testMoreBasics() {
        val moreBasicsTestCase = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.MoreBasics","slot":"conditional_slot"}]}""",
    ...
    fun testConfirmedSlot() {
        val confirmedSlotTestCase = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.IntentNeedConfirm","slot":"intVar"}]}""",
            ...
            """<{"activeFrames":[{"frame":"io.opencui.core.Confirmation","slot":"status"},{"frame":"io.opencui.test.IntentNeedConfirm","slot":"boolVar"}]}""",
            """>{"query": "3", "frames": [{"type": "Yes", "slots": []}]}""",
            """<{"type":"SlotAskAction","payload":"r u sure of the frame values 4 true str"}""",
            """<{"activeFrames":[{"frame":"io.opencui.core.Confirmation","slot":"status"},{"frame":"io.opencui.test.IntentNeedConfirm"}]}""",
    ...
    fun testConfirmedSlot2() {
        val confirmedSlotTestCase2 = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.IntentNeedConfirm","slot":"boolVar"}]}""",
    ...
    fun testIntentSuggestion() {
        val intentSuggestionTestCase = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.core.IntentSuggestion","slot":"intentPackage"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
    ...
    fun testSideIntent() {
        val sideIntentTestCase = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.ContractBasedIntentA","slot":"contractId"}]}""",
    ...
    fun testRecover() {
        ...
        val recoverTestCase = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.RecoverTestIntent","slot":"bbb"}]}""",
            """>{"query": "2", "frames": [{"type": "CleanSession", "packageName": "io.opencui.core", "slots": []}]}""",
            """<{"type":"CloseSession","payload":"CLEAN SESSION"}""",
            """<null""",
    ...
    fun testAssociation() {
        val assocationTestCase = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.AssociationTestIntent","slot":"bbb"}]}""",
    ...
    fun testValueRecInteractionPrompt() {
        val valueRecInteractionPromptTest = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.ValueRecInteractionFrame"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.ValueRecInteractionFrame","slot":"b"}]}""",
    ...
    fun testValueRecInteractionBypass() {
        val valueRecInteractionBypassTest = listOf(
            ...
            """<{"type":"SeqAction","payload":[{"type":"SeqAction","payload":[{"type":"DirectlyFillAction","payload":"FILL SLOT for target : io.opencui.core.PagedSelectable, slot : conditionMap"},{"type":"DirectlyFillAction","payload":"FILL SLOT for target : io.opencui.core.PagedSelectable, slot : page"},{"type":"ReinitAction","payload":"REINIT SLOT : target=io.opencui.core.PagedSelectable&slot=index"},{"type":"CleanupAction","payload":"CLEANUP SLOT : target=io.opencui.core.PagedSelectable&slot=index"}]}]}""",
            """<{"type":"SeqAction","payload":[{"type":"FillAction","payload":"FILL SLOT for target : io.opencui.test.ValueRecInteractionFrame, slot : "}]}""",
            """<{"type":"SeqAction","payload":[{"type":"SlotNotifyFailure","payload":"b=4; c=true; value check failed"},{"type":"CleanupAction","payload":"CLEANUP SLOT : target=io.opencui.test.ValueRecInteractionFrame&slot="},{"type":"RefocusAction","payload":""}]}""",
            """<{"type":"FillAction","payload":"FILL SLOT value is null for target : io.opencui.core.PagedSelectable, slot : index"}""",
            """<{"type":"SlotAskAction","payload":"We have following 3 choices: (1; true), (2; true), (3; true)."}""",
            """<{"activeFrames":[{"frame":"io.opencui.test.ValueRecInteractionFrame"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
    ...
    fun testAbortIntent() {
        val abortIntentTest = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.core.HasMore","slot":"status"},{"frame":"io.opencui.test.Main","slot":"skills"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
    ...
    fun testMultiValueEntityRecIntent() {
        val multiValueEntityRecTest = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.core.HasMore","slot":"status"},{"frame":"io.opencui.test.MultiValueEntityRecIntent","slot":"payMethodList"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
            """>{"query": "2", "frames": [{"type": "Yes", "slots": [], "packageName": "io.opencui.core.hasMore"}]}""",
            """<{"type":"FillAction","payload":"FILL SLOT value is null for target : io.opencui.core.PagedSelectable, slot : index"}""",
            """<{"type":"SlotAskAction","payload":"payMethod?\n\nWe have following 3 choices for PayMethod : visa_norm, mastercard_norm, paypal_norm."}""",
            """<{"activeFrames":[{"frame":"io.opencui.test.MultiValueEntityRecIntent","slot":"payMethodList"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
    ...
    fun testMultiValueFrameRecIntent() {
        val multiValueFrameRecTest = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.core.HasMore","slot":"status"},{"frame":"io.opencui.test.Hotel"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
    ...
    fun testCustomizedRecommendation() {
        val customizedRecommendation = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.Hotel","slot":"city"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
            """>{"query": "2", "frames": [{"type": "PagedSelectable", "slots": [{"value" : "\"1\"", "attribute" : "index"}]}]}""",
    ...
    fun testValueRecForIIntent() {
        val valueRecForIIntent = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.InternalNodeIntent","slot":"skill"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
            """>{"query": "2", "frames": [{"type": "PagedSelectable", "slots": [{"value" : "\"1\"", "attribute" : "index"}]}]}""",
    ...
    fun testEntityRecSelection() {
        val entityRecSelection = listOf(
            ...
            """<{"type":"FillAction","payload":"FILL SLOT value is null for target : io.opencui.core.PagedSelectable, slot : index"}""",
            """<{"type":"SlotAskAction","payload":"payMethod?\n\nWe have following 3 choices for PayMethod : visa_norm, mastercard_norm, paypal_norm."}""",
            """<{"activeFrames":[{"frame":"io.opencui.test.EntityRecSelection","slot":"payMethod"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
    ...
    fun testShowOnceRecommendation() {
        ...
        val showOnceRecommendation = listOf(
            ...
            """<{"type":"FillAction","payload":"FILL SLOT value is null for target : io.opencui.core.PagedSelectable, slot : index"}""",
            """<{"type":"SlotAskAction","payload":"payMethod?\nWe have following 3 choices for PayMethod : visa_norm, mastercard_norm, paypal_norm."}""",
            """<{"activeFrames":[{"frame":"io.opencui.core.HasMore","slot":"status"},{"frame":"io.opencui.test.ShowOnceRecommendation","slot":"payMethodList"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
            """>{"query": "2", "frames": [{"type": "PagedSelectable", "slots": [{"value" : "\"1\"", "attribute" : "index"}]}]}""",
    ...
    fun testMultiValueValueCheck() {
        val multiValueValueCheck = listOf(
            ...
            """<{"type":"SlotAskAction","payload":"payMethod?"}""",
            """<{"activeFrames":[{"frame":"io.opencui.core.HasMore","slot":"status"},{"frame":"io.opencui.test.MultiValueValueCheck","slot":"payMethodList"}]}""",
            ...
            """<{"type":"SeqAction","payload":[{"type":"SlotNotifyFailure","payload":"payMethodList check failed, size = 1"},{"type":"CleanupAction","payload":"CLEANUP SLOT : target=io.opencui.test.MultiValueValueCheck&slot=payMethodList"},{"type":"RefocusAction","payload":""}]}""",
            """<{"type":"SlotAskAction","payload":"payMethod?"}""",
            """<{"activeFrames":[{"frame":"io.opencui.core.HasMore","slot":"status"},{"frame":"io.opencui.test.MultiValueValueCheck","slot":"payMethodList"}]}""",
    ...
    fun testSepConfirmExplicit() {
        ...
        val sepConfirmation = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.core.Confirmation","slot":"status"},{"frame":"io.opencui.test.SepTestIntentExplicit","slot":"b"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
            ...
            """<{"activeFrames":[{"frame":"io.opencui.core.Confirmation","slot":"status"},{"frame":"io.opencui.test.SepTestIntentExplicit","slot":"b"}]}""",
            """>{"query": "3", "frames": [{"type": "Yes", "slots": []}]}""",
    ...
    fun testSepConfirmImplicit() {
        val sepConfirmation = listOf(
            ...
            """<{"type":"FillAction","payload":"FILL SLOT for target : io.opencui.core.PagedSelectable, slot : index"}""",
            """<{"type":"SlotAskAction","payload":"b ?\nsep confirmation b=2, contextC=ccc"}""",
            """<{"activeFrames":[{"frame":"io.opencui.core.Confirmation","slot":"status"},{"frame":"io.opencui.test.SepTestIntentImplicit","slot":"b"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
            """>{"query": "2", "frames": [{"type": "Yes", "slots": []}]}""",
            """<{"type":"SeqAction","payload":[{"type":"FillAction","payload":"FILL SLOT for target : io.opencui.test.SepTestIntentImplicit, slot : b"}]}""",
            """<{"type":"SlotAskAction","payload":"original confirmation b=2"}""",
            """<{"activeFrames":[{"frame":"io.opencui.core.Confirmation","slot":"status"},{"frame":"io.opencui.test.SepTestIntentImplicit","slot":"b"}]}""",
            """>{"query": "3", "frames": [{"type": "Yes", "slots": []}]}""",
    ...
    fun testMinMaxCheck() {
        val minMaxValueCheck = listOf(
            ...
            """<{"type":"SlotAskAction","payload":"payMethod?"}""",
            """<{"activeFrames":[{"frame":"io.opencui.core.HasMore","slot":"status"},{"frame":"io.opencui.test.MultiValueMinMax","slot":"payMethodList"}]}""",
            """>{"query": "2", "frames": [{"type": "No", "slots": []}]}""",
            """<{"type":"SeqAction","payload":[{"type":"SlotNotifyFailure","payload":"size = 0 less than 1"},{"type":"CleanupAction","payload":"CLEANUP SLOT : target=io.opencui.core.HasMore&slot=status"},{"type":"RefocusAction","payload":""}]}""",
            """<{"type":"SlotAskAction","payload":"payMethod?"}""",
            """<{"activeFrames":[{"frame":"io.opencui.core.HasMore","slot":"status"},{"frame":"io.opencui.test.MultiValueMinMax","slot":"payMethodList"}]}""",
    ...
    fun testMinMaxSep() {
        val minMaxSep = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.core.HasMore","slot":"status"},{"frame":"io.opencui.test.MultiValueMinMaxWithRec","slot":"payMethodList"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
    ...
    fun testValueCheckSwitch() {
        val valueCheckSwitchTest = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.ValueCheckSwitchTest","slot":"a"}]}""",
            """>{"query": "2", "frames": [{"type": "ValueCheckSwitchTest", "slots": [{"value": "1", "attribute": "a"}]}]}""",
            """<{"type":"SeqAction","payload":[{"type":"SlotNotifyFailure","payload":"no such a = 1"},{"type":"CleanupAction","payload":"CLEANUP SLOT : target=io.opencui.test.ValueCheckSwitchTest&slot=a"},{"type":"RefocusAction","payload":""}]}""",
            """<{"type":"SlotAskAction","payload":"a?"}""",
            """<{"activeFrames":[{"frame":"io.opencui.test.ValueCheckSwitchTest","slot":"a"}]}""",
            """>{"query": "3", "frames": [{"type": "ValueCheckSwitchTest", "slots": [{"value": "3", "attribute": "a"}]}]}""",
            """<{"type":"SlotAskAction","payload":"c?"}""",
            """<{"activeFrames":[{"frame":"io.opencui.test.ValueCheckSwitchTest","slot":"c"}]}""",
            """>{"query": "4", "frames": [{"type": "ValueCheckSwitchTest", "slots": [{"value": "2", "attribute": "a"}]}]}""",
            """<{"type":"SeqAction","payload":[{"type":"SlotNotifyFailure","payload":"no such combination of a = 2 b = true"},{"type":"CleanupAction","payload":"CLEANUP SLOT : target=io.opencui.test.ValueCheckSwitchTest&slot=a, target=io.opencui.test.ValueCheckSwitchTest&slot=b"},{"type":"RefocusAction","payload":""}]}""",
            """<{"type":"SlotAskAction","payload":"a?"}""",
            """<{"activeFrames":[{"frame":"io.opencui.test.ValueCheckSwitchTest","slot":"a"}]}""",
            """>{"query": "5", "frames": [{"type": "ValueCheckSwitchTest", "slots": [{"value": "3", "attribute": "a"}]}]}""",
            """<{"type":"SlotAskAction","payload":"b?"}""",
            """<{"activeFrames":[{"frame":"io.opencui.test.ValueCheckSwitchTest","slot":"b"}]}""",
            """>{"query": "6", "frames": [{"type": "ValueCheckSwitchTest", "slots": [{"value": "false", "attribute": "b"}]}]}""",
            """<{"type":"SeqAction","payload":[{"type":"SlotNotifyFailure","payload":"no such combination of a = 3 b = false"},{"type":"CleanupAction","payload":"CLEANUP SLOT : target=io.opencui.test.ValueCheckSwitchTest&slot=a, target=io.opencui.test.ValueCheckSwitchTest&slot=b"},{"type":"RefocusAction","payload":""}]}""",
            """<{"type":"SlotAskAction","payload":"a?"}""",
            """<{"activeFrames":[{"frame":"io.opencui.test.ValueCheckSwitchTest","slot":"a"}]}""",
    ...
    fun testValueClarification() {
        val valueClarificationTest = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.BookTrain","slot":"placeHolder"}]}""",
            ...
            """<{"activeFrames":[{"frame":"io.opencui.core.ValueClarification${'$'}io.opencui.test.City","slot":"target"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
    ...
    fun testMultiValueValueClarification() {
        val multiValueValueClarificationTest = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.core.HasMore","slot":"status"},{"frame":"io.opencui.test.CollectCities","slot":"cities"}]}""",
    ...
    fun testBoolGate() {
         val BoolGateTest = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.core.BoolGate","slot":"status"},{"frame":"io.opencui.test.BoolGateTestIntent","slot":"city"}]}""",
            """>{"query": "2", "frames": [{"type": "Yes", "slots": [], "packageName": "io.opencui.core.booleanGate"}]}""",
            """<{"type":"SlotAskAction","payload":"city?"}""",
            """<{"activeFrames":[{"frame":"io.opencui.test.BoolGateTestIntent","slot":"city"}]}""",
            """>{"query": "3", "frames": [{"type": "BoolGateTestIntent", "slots": [{"value" : "\"Beijing\"", "attribute" : "city"}]}]}""",
            """<{"type":"SlotAskAction","payload":"placeHolder?"}""",
            """<{"activeFrames":[{"frame":"io.opencui.test.BoolGateTestIntent","slot":"placeHolder"}]}""",
    ...
    fun testNeverAsk() {
        val NeverAskTest = listOf(
            ...
            """<{"type":"SlotAskAction","payload":"city?"}""",
            """<{"activeFrames":[{"frame":"io.opencui.test.NeverAskIntent","slot":"city"}]}""",
    ...
    fun testZep() {
        val ZepTest = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.ZepTestIntent","slot":"citySoft"}]}""",
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.ZepTestIntent","slot":"cityHard"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
            ...
            """<{"activeFrames":[{"frame":"io.opencui.core.HasMore","slot":"status"},{"frame":"io.opencui.test.ZepTestIntent","slot":"citiesSoft"}]}""",
            ...
            """<{"activeFrames":[{"frame":"io.opencui.core.HasMore","slot":"status"},{"frame":"io.opencui.test.ZepTestIntent","slot":"citiesHard"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
    ...
    fun testSlotUpdate() {
        val SlotUpdateTest = listOf(
            ...
            """<{"type":"SlotValueInform","payload":"we have updated null form Beijing_norm to Shanghai_norm for you"}""",
            ...
            """<{"type":"DirectlyFillAction","payload":"FILL SLOT for target : io.opencui.test.SlotUpdate, slot : originalValue"}""",
            """<{"type":"SlotAskAction","payload":"You just said Chengdu_norm, do you mean you want to change null from Shanghai_norm?"}""",
            """<{"activeFrames":[{"frame":"io.opencui.core.Confirmation","slot":"status"},{"frame":"io.opencui.test.SlotUpdate","slot":"confirm"}]}""",
            ...
            """<{"type":"SeqAction","payload":[{"type":"FillAction","payload":"FILL SLOT for target : io.opencui.test.SlotUpdateTestIntent, slot : cityFrom"},{"type":"CleanupAction","payload":"CLEANUP SLOT : target=io.opencui.test.SlotUpdateTestIntent&slot=cityFrom"},{"type":"RefocusAction","payload":""}]}""",
            """<{"type":"SlotValueInform","payload":"we have updated null form Shanghai_norm to Shenzhen_norm for you"}""",
            ...
            """<{"type":"FillAction","payload":"FILL SLOT value is null for target : io.opencui.core.PagedSelectable, slot : index"}""",
            """<{"type":"SlotAskAction","payload":"What do you want for null?\nWe have following 2 choices: (Beijing_norm), (Shanghai_norm)."}""",
            """<{"activeFrames":[{"frame":"io.opencui.test.SlotUpdateTestIntent","slot":"cityFrom"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
            ...
            """<{"activeFrames":[{"frame":"io.opencui.core.HasMore","slot":"status"},{"frame":"io.opencui.test.SlotUpdateTestIntent","slot":"citiesFrom"}]}""",
            ...
            """<{"type":"FillAction","payload":"FILL SLOT value is null for target : io.opencui.core.PagedSelectable, slot : index"}""",
            """<{"type":"SlotAskAction","payload":"target?\nby , which do you mean: (null), (null)."}""",
            """<{"activeFrames":[{"frame":"io.opencui.core.ValueClarification${'$'}io.opencui.core.SlotType","slot":"target"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
            """>{"query": "15", "frames": [{"type": "PagedSelectable", "slots": [{"value" : "\"2\"", "attribute" : "index"}]}]}""",
            """<{"type":"SeqAction","payload":[{"type":"FillAction","payload":"FILL SLOT for target : io.opencui.core.ValueClarification, slot : target"}]}""",
            ...
            """<{"type":"SlotValueInform","payload":"we have updated null form Beijing_norm to Chengdu_norm for you"}""",
            """<{"type":"SlotAskAction","payload":"citiesFrom?"}""",
            """<{"activeFrames":[{"frame":"io.opencui.core.HasMore","slot":"status"},{"frame":"io.opencui.test.SlotUpdateTestIntent","slot":"citiesFrom"}]}""",
            ...
            """<{"activeFrames":[{"frame":"io.opencui.core.HasMore","slot":"status"},{"frame":"io.opencui.test.SlotUpdateTestIntent","slot":"citiesTo"}]}""",
            ...
            """<{"type":"SlotValueInform","payload":"we have updated the 1st null form Beijing_norm to Shanghai_norm for you"}""",
            """<{"type":"SlotAskAction","payload":"any citiesTo else?"}""",
            """<{"activeFrames":[{"frame":"io.opencui.core.HasMore","slot":"status"},{"frame":"io.opencui.test.SlotUpdateTestIntent","slot":"citiesTo"}]}""",
            ...
            """<{"type":"DirectlyFillAction","payload":"FILL SLOT for target : io.opencui.test.SlotUpdate, slot : originalValue"}""",
            """<{"type":"SlotAskAction","payload":"You just said Beijing_norm, do you mean you want to change 1st null from Shanghai_norm?"}""",
            """<{"activeFrames":[{"frame":"io.opencui.core.Confirmation","slot":"status"},{"frame":"io.opencui.test.SlotUpdate","slot":"confirm"}]}""",
            """>{"query": "20", "frames": [{"type": "Yes", "slots": [], "packagename": "io.opencui.core.confirmation"}]}""",
            """<{"type":"SeqAction","payload":[{"type":"FillAction","payload":"FILL SLOT for target : io.opencui.test.SlotUpdateTestIntent, slot : citiesFrom._item"},{"type":"CleanupAction","payload":"CLEANUP SLOT : target=io.opencui.test.SlotUpdateTestIntent&slot=citiesFrom._item"},{"type":"RefocusAction","payload":""}]}""",
            """<{"type":"SlotValueInform","payload":"we have updated the 1st null form Shanghai_norm to Beijing_norm for you"}""",
            """<{"type":"SlotAskAction","payload":"any citiesTo else?"}""",
            """<{"activeFrames":[{"frame":"io.opencui.core.HasMore","slot":"status"},{"frame":"io.opencui.test.SlotUpdateTestIntent","slot":"citiesTo"}]}""",
            // cityFrom = Shanghai; cityTo = Chengdu; citiesFrom = [Beijing, Beijing]; citiesTo = [Chengdu, Shenzhen]
            ...
            """<{"type":"SeqAction","payload":[{"type":"SlotNotifyFailure","payload":"There's no 3rd value in null"},{"type":"CleanupAction","payload":"CLEANUP SLOT : target=io.opencui.test.SlotUpdate&slot=index"},{"type":"RefocusAction","payload":""}]}""",
            """<{"type":"FillAction","payload":"FILL SLOT value is null for target : io.opencui.core.PagedSelectable, slot : index"}""",
            """<{"type":"SlotAskAction","payload":"There are multiple values in null. Which one do you want to change?\n1. 1st value: Beijing_norm\n2. 2nd value: Beijing_norm"}""",
            """<{"activeFrames":[{"frame":"io.opencui.test.SlotUpdate","slot":"index"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
            ...
            """<{"type":"SlotAskAction","payload":"What do you want for 1st null?"}""",
            """<{"activeFrames":[{"frame":"io.opencui.test.SlotUpdateTestIntent","slot":"citiesFrom"}]}""",
            ...
            """<{"type":"DirectlyFillAction","payload":"FILL SLOT for target : io.opencui.test.SlotUpdate, slot : originalValue"}""",
            """<{"type":"SeqAction","payload":[{"type":"FillAction","payload":"FILL SLOT for target : io.opencui.test.SlotUpdateTestIntent, slot : citiesFrom._item"},{"type":"CleanupAction","payload":"CLEANUP SLOT : target=io.opencui.test.SlotUpdateTestIntent&slot=citiesFrom._item"},{"type":"RefocusAction","payload":""}]}""",
            """<{"type":"SlotValueInform","payload":"we have updated the 1st null form Zhengzhou_norm to Shenzhen_norm for you"}""",
            """<{"type":"SlotAskAction","payload":"any citiesTo else?"}""",
            """<{"activeFrames":[{"frame":"io.opencui.core.HasMore","slot":"status"},{"frame":"io.opencui.test.SlotUpdateTestIntent","slot":"citiesTo"}]}""",
            ...
            """<{"type":"SlotValueInform","payload":"we have updated the 1st null form Chengdu_norm to Shenzhen_norm for you"}""",
            """<{"type":"SlotAskAction","payload":"any citiesTo else?"}""",
            """<{"activeFrames":[{"frame":"io.opencui.core.HasMore","slot":"status"},{"frame":"io.opencui.test.SlotUpdateTestIntent","slot":"citiesTo"}]}""",
    ...
    fun testEarlyTermination() {
        val EarlyTerminationTest = listOf(
            ...
            """<{"type":"SlotAskAction","payload":"a?"}""",
            """<{"activeFrames":[{"frame":"io.opencui.test.EarlyTerminationFrame","slot":"a"}]}""",
    ...
    fun testSoftEarlyTermination() {
        val SoftEarlyTerminationTest = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.core.Confirmation","slot":"status"},{"frame":"io.opencui.test.SoftEarlyTerminationIntent"}]}""",
    ...
    fun testValueRecommendation() {
        val ValueRecommendationTest = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.ReturnValueTestIntent","slot":"b"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
            """>{"query": "2", "frames": []}""",
            """<{"type":"UserDefinedInform","payload":"I did not get that."}""",
            """<{"activeFrames":[{"frame":"io.opencui.test.ReturnValueTestIntent","slot":"b"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.ValueRecommendationTest","slot":"s"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
    ...
    fun testDirectlyFillMultiValueSlot() {
        val test = listOf(
                ...
                """<{"type":"SlotAskAction","payload":"payMethod?"}""",
                """<{"activeFrames":[{"frame":"io.opencui.core.HasMore","slot":"status"},{"frame":"io.opencui.test.DirectlyFillMultiValueSlotTest","slot":"payMethodList"}]}""",
                ...
                """>{"query": "4", "frames": [{"type": "No", "slots": [], "packageName": "io.opencui.core.hasMore"}]}""",
                """<{"type":"SlotAskAction","payload":"s?"}""",
                """<{"activeFrames":[{"frame":"io.opencui.test.DirectlyFillMultiValueSlotTest","slot":"s"}]}""",
    ...
    fun testMVEntryConfirmation() {
        val test = listOf(
                ...
                """<{"type":"SlotAskAction","payload":"s?"}""",
                """<{"activeFrames":[{"frame":"io.opencui.test.MVEntryConfirmationTestIntent","slot":"s"}]}""",
                """>{"query": "2", "frames": [{"type": "MVEntryConfirmationTestIntent", "slots": [{"value" : "\"aaa\"", "attribute" : "s"}], "packageName": "io.opencui.test"}]}""",
                """<{"type":"SlotAskAction","payload":"payMethod?"}""",
                """<{"activeFrames":[{"frame":"io.opencui.core.HasMore","slot":"status"},{"frame":"io.opencui.test.MVEntryConfirmationTestIntent","slot":"payMethodList"}]}""",
                """>{"query": "3", "frames": [{"type": "MVEntryConfirmationTestIntent", "slots": [{"value" : "\"visa\"", "attribute" : "payMethodList"}], "packageName": "io.opencui.test"}]}""",
                """<{"type":"SlotValueInform","payload":"you chose visa"}""",
                """<{"type":"SlotAskAction","payload":"anything else?"}""",
                """<{"activeFrames":[{"frame":"io.opencui.core.HasMore","slot":"status"},{"frame":"io.opencui.test.MVEntryConfirmationTestIntent","slot":"payMethodList"}]}""",
                ...
                """<{"type":"SlotValueInform","payload":"you chose mastercard"}""",
                """<{"type":"SlotAskAction","payload":"anything else?"}""",
                """<{"activeFrames":[{"frame":"io.opencui.core.HasMore","slot":"status"},{"frame":"io.opencui.test.MVEntryConfirmationTestIntent","slot":"payMethodList"}]}""",
                """>{"query": "5", "frames": [{"type": "No", "slots": [], "packageName": "io.opencui.core.hasMore"}]}""",
    ...
    fun testValueCheck() {
        val test = listOf(
                ...
                """<{"type":"SeqAction","payload":[{"type":"SlotNotifyFailure","payload":"b fails"},{"type":"CleanupAction","payload":"CLEANUP SLOT : target=io.opencui.test.VCTestIntent&slot=b"},{"type":"RefocusAction","payload":""}]}""",
                """<{"type":"SlotAskAction","payload":"b?"}""",
                """<{"activeFrames":[{"frame":"io.opencui.test.VCTestIntent","slot":"b"}]}""",
                """>{"query": "2", "frames": [{"type": "VCTestIntent", "slots": [{"value" : "\"b\"", "attribute" : "b"}], "packageName": "io.opencui.test"}]}""",
                """<{"type":"SlotAskAction","payload":"c?"}""",
                """<{"activeFrames":[{"frame":"io.opencui.test.VCTestIntent","slot":"c"}]}""",
                """>{"query": "3", "frames": [{"type": "VCTestIntent", "slots": [{"value" : "true", "attribute" : "c"}], "packageName": "io.opencui.test"}]}""",
                """<{"type":"SlotAskAction","payload":"d?"}""",
                """<{"activeFrames":[{"frame":"io.opencui.test.VCTestIntent","slot":"d"}]}""",
                ...
                """<{"type":"SlotAskAction","payload":"a?"}""",
                """<{"activeFrames":[{"frame":"io.opencui.test.VCTestIntent","slot":"a"}]}""",
    ...
    fun testValueReCheck() {
        val test = listOf(
                ...
                """<{"type":"SlotAskAction","payload":"c?"}""",
                """<{"activeFrames":[{"frame":"io.opencui.test.ValueRecheckTestIntent","slot":"c"}]}""",
                ...
                """<{"type":"SlotAskAction","payload":"a?"}""",
                """<{"activeFrames":[{"frame":"io.opencui.test.ValueRecheckTestIntent","slot":"a"}]}""",
                ...
                """<{"type":"SlotAskAction","payload":"b?"}""",
                """<{"activeFrames":[{"frame":"io.opencui.test.ValueRecheckTestIntent","slot":"b"}]}""",
                ...
                """<{"type":"SlotAskAction","payload":"d?"}""",
                """<{"activeFrames":[{"frame":"io.opencui.test.ValueRecheckTestIntent","slot":"d"}]}""",
    ...
    fun testKernelIntent() {
        val test = listOf(
                ...
                """<{"type":"UserDefinedInform","payload":"Good day!"}""",
                """<{"type":"SlotAskAction","payload":"What is your cell number?"}""",
                """<{"activeFrames":[{"frame":"io.opencui.test.UserInit","slot":"cellPhone"}]}""",
                """>{"query": "2", "frames": [{"type": "UserInit", "slots": [{"value" : "\"12345678910\"", "attribute" : "cellPhone"}], "packageName": "io.opencui.test"}]}""",
                """<{"type":"SlotAskAction","payload":"What is your name?"}""",
                """<{"activeFrames":[{"frame":"io.opencui.test.UserInit","slot":"userName"}]}""",
                ...
                """<{"activeFrames":[{"frame":"io.opencui.core.HasMore","slot":"status"},{"frame":"io.opencui.test.MainWithKernelIntent","slot":"skills"}]}""",
    ...
    fun testOutlierValueForValueRec() {
        val test = listOf(
                ...
                """<{"activeFrames":[{"frame":"io.opencui.test.ValueRecOutlierValueIntent","slot":"s"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
                """>{"query": "2", "frames": [{"type": "PagedSelectable", "slots": [{"value" : "\"6\"", "attribute" : "index"}]}]}""",
                """<{"type":"SeqAction","payload":[{"type":"SeqAction","payload":[{"type":"SlotOfferOutlier","payload":"outlier index : 6"},{"type":"ReinitAction","payload":"REINIT SLOT : target=io.opencui.core.PagedSelectable&slot=index"},{"type":"CleanupAction","payload":"CLEANUP SLOT : target=io.opencui.core.PagedSelectable&slot=index"}]}]}""",
                """<{"type":"FillAction","payload":"FILL SLOT value is null for target : io.opencui.core.PagedSelectable, slot : index"}""",
                """<{"type":"SlotAskAction","payload":"s?\nWe have following 3 choices: (a), (b), (c)."}""",
                """<{"activeFrames":[{"frame":"io.opencui.test.ValueRecOutlierValueIntent","slot":"s"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
                ...
                """<{"type":"SeqAction","payload":[{"type":"SeqAction","payload":[{"type":"DirectlyFillAction","payload":"FILL SLOT for target : io.opencui.core.PagedSelectable, slot : conditionMap"},{"type":"DirectlyFillAction","payload":"FILL SLOT for target : io.opencui.core.PagedSelectable, slot : page"},{"type":"ReinitAction","payload":"REINIT SLOT : target=io.opencui.core.PagedSelectable&slot=index"},{"type":"CleanupAction","payload":"CLEANUP SLOT : target=io.opencui.core.PagedSelectable&slot=index"}]}]}""",
                """<{"type":"FillAction","payload":"FILL SLOT for target : io.opencui.core.PagedSelectable, slot : index"}""",
                """<{"type":"SeqAction","payload":[{"type":"SeqAction","payload":[{"type":"SlotOfferOutlier","payload":"outlier value: d"},{"type":"ReinitAction","payload":"REINIT SLOT : target=io.opencui.core.PagedSelectable&slot=index"},{"type":"CleanupAction","payload":"CLEANUP SLOT : target=io.opencui.core.PagedSelectable&slot=page, target=io.opencui.core.PagedSelectable&slot=conditionMap, target=io.opencui.core.PagedSelectable&slot=index"}]}]}""",
                """<{"type":"FillAction","payload":"FILL SLOT value is null for target : io.opencui.core.PagedSelectable, slot : index"}""",
                """<{"type":"SlotAskAction","payload":"s?\nWe have following 3 choices: (a), (b), (c)."}""",
                """<{"activeFrames":[{"frame":"io.opencui.test.ValueRecOutlierValueIntent","slot":"s"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
    ...
    fun testSepNo() {
        val test = listOf(
                ...
                """<{"activeFrames":[{"frame":"io.opencui.core.Confirmation","slot":"status"},{"frame":"io.opencui.test.TestSepNoIntent","slot":"s"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
                ...
                """<{"activeFrames":[{"frame":"io.opencui.core.Confirmation","slot":"status"},{"frame":"io.opencui.test.TestSepNoIntent","slot":"ss"},{"frame":"io.opencui.core.HasMore","slot":"status"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
    ...
    fun testFreeActionConfirmation() {
        val test = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.core.Confirmation","slot":"status"},{"frame":"io.opencui.core.FreeActionConfirmation","slot":"status"}]}""",
            """>{"query": "2", "frames": [{"type": "No", "slots": [], "packagename": "io.opencui.core.confirmation"}]}""",
            ...
            """<{"activeFrames":[{"frame":"io.opencui.core.Confirmation","slot":"status"},{"frame":"io.opencui.core.FreeActionConfirmation","slot":"status"}]}""",
            """>{"query": "4", "frames": [{"type": "Yes", "slots": [], "packagename": "io.opencui.core.confirmation"}]}""",
            """<{"type":"SlotValueInform","payload":"we have updated null form aaa to bbb for you"}""",
    ...
    fun testResumeIntent() {
        val test = listOf(
            ...
            """<{"type":"SlotAskAction","payload":"s?"}""",
            """<{"activeFrames":[{"frame":"io.opencui.test.SimpleIntent","slot":"s"}]}""",
            """>{"query": "2", "frames": [{"type": "SimpleIntent", "slots": [], "packageName": "io.opencui.test"}]}""",
            """<{"type":"UserDefinedInform","payload":"We are in the middle of io.opencui.test.SimpleIntent already, let's continue with the current process."}""",
            """<{"type":"SlotAskAction","payload":"s?"}""",
            """<{"activeFrames":[{"frame":"io.opencui.test.SimpleIntent","slot":"s"}]}""",
    ...
    fun testExternalEventStrategy() {
        val test = listOf(
                ...
                """<{"type":"UserDefinedInform","payload":"s=aaa"}""",
                """<{"type":"SlotValueInform","payload":"implicitly confirm this intent.s=aaa"}""",
    ...
    fun testContextBasedRecommendation() {
        val test = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.ContextBasedRecFrame"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
            """>{"query": "2", "frames": [{"type": "PagedSelectable", "slots": [{"value" : "\"2\"", "attribute" : "index"}]}]}""",
    ...
    fun testSlotSepInformConfirmComposite() {
        val test = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.core.Confirmation","slot":"status"},{"frame":"io.opencui.test.SlotDoubleConfirmTestIntent","slot":"slot"}]}""",
            """>{"query": "2", "frames": [{"type": "Yes", "slots": []}]}""",
    ...
    fun testAbstractEntity() {
        val test = listOf(
            ...
            """<{"activeFrames":[{"frame":"io.opencui.test.AbstractEntityIntent","slot":"dish"},{"frame":"io.opencui.core.PagedSelectable","slot":"index"}]}""",
            """>{"query": "2", "frames": [{"type": "PagedSelectable", "slots": [{"value" : "\"2\"", "attribute" : "index"}]}]}""",
