...
class ZhSearchTest() : DuTestHelper() {
    val test = """{$}"""
    val expressionJson = """{
        "agent_id":"CarFinanceSimple",
        "expressions":[
        {"owner_id":"io.opencui.core.CleanSession",
         "expressions":[
            {"utterance":"结束当前对话"}]
        },
        {"owner_id":"io.opencui.core.DontCare",
         ...
         {"owner_id":"io.opencui.core.confirmation.IStatus",
          "expressions":[
            ...
            {"utterance":"是的",
             "context":{
                "frame_id":"Regression.CarFinanceSimple.v_04a227a81a6b025230d9ac2882267507.EarlyTerminationImpl",
                "attribute_id":"date"}}]
           },
           {"owner_id":"io.opencui.core.confirmation.IStatus",
            "expressions":[
           ...
           "expressions":[
            ...
            {"owner_id":"Regression.CarFinanceSimple.v_04a227a81a6b025230d9ac2882267507.Greeting",
             "expressions":[
                {"utterance":"你好"},
                {"utterance":"您好"}]
            },
            {"owner_id":"io.opencui.core.PagedSelectable",
             "expressions":[
                {"utterance":"下一页",
                 "context":{
                    "frame_id":"io.opencui.core.PagedSelectable"}},
                {"utterance":"翻页",
                 "context":{"frame_id":"io.opencui.core.PagedSelectable"}},
                {"utterance":"还有别的吗？", "context":{"frame_id":"io.opencui.core.PagedSelectable"}},
                {"utterance":"都不太喜欢","context":{"frame_id":"io.opencui.core.PagedSelectable"}},
                {"utterance":"上一页","context":{"frame_id":"io.opencui.core.PagedSelectable"}}]
             },
             {"owner_id":"Regression.CarFinanceSimple.v_04a227a81a6b025230d9ac2882267507.HowMuchMoneyDoIOwn",
              "expressions":[
              {"utterance":"我还有多少钱没有还？"},
              {"utterance":"我还欠多少钱?"},
              {"utterance":"还有多少钱没还"}]
             },
             {"owner_id":"Regression.CarFinanceSimple.v_04a227a81a6b025230d9ac2882267507.EarlyTermination",
              "expressions":[
                {"utterance":"我想提前还款"},
                {"utterance":"提前结清"}]
             },
             {"owner_id":"io.opencui.core.AbortIntent",
              "expressions":[
                    {"utterance":"我不要了"},
                    {"utterance":"我不想了"}]}]}""".trimIndent()
